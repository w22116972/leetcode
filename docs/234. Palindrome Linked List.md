...
The leetcode is to find the middle of linked list and use that middle node to reverse second half of the linked list. Then compare two half of linked list.
